        ...
        <div className="px-4 py-6 sm:px-0">
          <div className="border-4 border-dashed border-gray-200 rounded-lg h-96 flex items-center justify-center">
            <div className="text-center">
              <h2 className="text-2xl font-bold mb-4">Welcome to Investment Research Platform</h2>
              <p className="text-gray-600 mb-4">Get started by creating a portfolio</p>
              <Link href="/portfolio" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                Go to Portfolio
              </Link>
            </div>
          </div>
